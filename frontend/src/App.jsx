                ...
                <div>
                  <div className="mb-3 flex flex-wrap items-center gap-2">
                    ...
                    <div className="flex items-center gap-2 rounded-md border border-gray-200 bg-white p-1 dark:border-gray-700 dark:bg-gray-800">
                      ...
                      <button className="rounded px-2 py-1 text-sm hover:bg-gray-50 dark:text-gray-200 dark:hover:bg-gray-700" onClick={() => setScale((s) => Math.min(3, parseFloat((s + 0.1).toFixed(2))))}>+</button>
